...
#Realizar un shell script que copie el fichero indicado como primer
#parámetro posicional de manera que la copia tenga el nombre indicado
#en el segundo parámetro posicional. Hay que controlar:
